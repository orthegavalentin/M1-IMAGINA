...
to setup
  ...
  ask patches with [pxcor >= 107 and pxcor <= 127 and pycor >= 107 and pycor <= 127] [
    set pcolor green
  ]
  
  set nombre-animaux 10;
  
  set-default-shape turtles "sheep 2"
...
to reproduce
  if(random 100 <= chance-reproduction AND nombre-animaux < 400)[
    create-animaux 1[
      set color white
      setxy random-xcor random-ycor
      set size 6
    ]
    set nombre-animaux nombre-animaux + 1
  ]
end
@#$#@#$#@
GRAPHICS-WINDOW
