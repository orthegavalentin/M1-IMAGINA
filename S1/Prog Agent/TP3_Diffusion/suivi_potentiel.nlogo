...
Démonstration du fonctionnement de suivi de potentiel par uphill. Des fourmis suivent des odeurs et remontent un gradient d'odeur..

##Comment l'utiliser

Quelques paramètres concernant l'évaporation et la diffusion des odeurs.  
Le paramètre chemical-min qui donne la sensibilité minimale des agents.. 
@#$#@#$#@
default
true
0
