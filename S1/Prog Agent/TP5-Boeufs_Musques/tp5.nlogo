...
to setup
  ...
  set-default-shape turtles "cow skull"
  create-boeuf nombre-boeufs [
...
to regrouper
  let boeuf-trouve one-of other boeuf in-radius distance-regard
  
  ifelse boeuf-trouve != nobody [
    face boeuf-trouve
    fd 1
    let boeuf-trop-pret one-of other boeuf in-radius distance-min
    if boeuf-trop-pret != nobody[
      face boeuf-trop-pret
      rt 180
      fd 1
    ]
  ]
